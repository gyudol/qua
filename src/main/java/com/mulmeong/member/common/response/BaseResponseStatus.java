...
public enum BaseResponseStatus {
    ...
    NO_SUPPORTED_PROVIDER(HttpStatus.BAD_REQUEST, false, 604, "지원하지 않는 플랫폼입니다."),
    INVALID_OAUTH(HttpStatus.BAD_REQUEST, false, 605, "올바르지 않은 소셜 계정입니다."),
    NO_EXIST_USER(HttpStatus.BAD_REQUEST, false, 606, "존재하지 않는 회원 정보입니다."),
    FAILED_TO_LOGIN(HttpStatus.UNAUTHORIZED, false, 607, "로그인에 실패하였습니다."),
    DISABLED_USER(HttpStatus.UNAUTHORIZED, false, 608, "비활성화된 계정입니다."),
    NO_ACCESS_AUTHORITY(HttpStatus.FORBIDDEN, false, 609, "접근 권한이 없습니다."),
