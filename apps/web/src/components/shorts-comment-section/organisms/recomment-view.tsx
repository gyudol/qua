...
import type { ShortsRecomment } from "@/types/comment/comment-read-service";
import { useGetShortsRecommentQuery } from "@/hooks";
...
interface RecommentViewProps extends ShortsRecomment {
  justNow?: boolean;
}
...
export function RecommentView({
  ...
  const { data: recomment } = useGetShortsRecommentQuery({ recommentUuid });
